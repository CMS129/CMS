 ...
 * @method \app\mvc\View view() Gets current view
 *
 * Request-response
...
class Engine {
     ...
     * @var array
     */
    protected static $dbsInstance = array();
    ...
    public function init() {
        ...
        $this->loader->register('coms', '\app\libs\common\Common');
        $this->loader->register('session','\app\libs\common\ModeSession');
        $this->loader->register('cookies','\app\libs\common\ModeCookies');
        $this->loader->register('view', '\app\mvc\View', array(), function($view) use ($self) {
